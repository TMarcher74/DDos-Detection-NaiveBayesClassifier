...
We had decided to use the ordered dataset and tried training the model on kaggle and ran into problems like shortage of memory (>30GB) and processing speed.
